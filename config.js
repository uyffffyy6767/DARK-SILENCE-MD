...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~vJBwjCYD#COr_IRVmR4Ku9L7kFqDGwfWqu1zYhWQmsVUlsEGN0yY",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "256784391777",
    OWNER_NAME: process.env.OWNER_NAME || "Robert",
